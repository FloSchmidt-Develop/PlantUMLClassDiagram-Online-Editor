...
export default class UserCreatedNewEdge{
    public static CreateNewEdgeFromCell(cell: any, graph: any): any{
        ...
        var e21 = graph.insertVertex(cell, connection.id + 'L', connection.multiplicity_left, -0.9, 10, 0, 0,
        'fontSize=14;fontColor=#000000;fillColor=#ffffff;strokeOpacity=100;fillOpacity=100;strokeWidth=0;', true);
        connection.multiplicity_left.vertex = e21;
        e21.isConnectable = () => false;

        var e12 = graph.insertVertex(cell, null, connection.multiplicity_right, 0.9, -10, 0, 0,
