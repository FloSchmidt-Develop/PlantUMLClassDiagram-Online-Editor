...
PlantUMLParser.prototype.class_declaration = function() {
    ...
    try {
        ...
        if(_la===PlantUMLParser.T__2) {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(((((_la - 6)) & ~0x1f) == 0 && ((1 << (_la - 6)) & ((1 << (PlantUMLParser.T__5 - 6)) | (1 << (PlantUMLParser.T__14 - 6)) | (1 << (PlantUMLParser.T__15 - 6)) | (1 << (PlantUMLParser.T__16 - 6)) | (1 << (PlantUMLParser.T__17 - 6)) | (1 << (PlantUMLParser.T__19 - 6)) | (1 << (PlantUMLParser.NEWLINE - 6)) | (1 << (PlantUMLParser.WORD - 6)))) !== 0)) {
                this.state = 141;
                this._errHandler.sync(this);
...
PlantUMLParser.prototype.attribute = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===PlantUMLParser.T__14 || _la===PlantUMLParser.T__19) {
            this.state = 186;
            this.modifiers();
        }
...
PlantUMLParser.prototype.modifiers = function() {
    ...
    try {
        ...
        case PlantUMLParser.T__14:
            this.enterOuterAlt(localctx, 2);
            this.state = 437;
            localctx.abstract_mod = this.match(PlantUMLParser.T__14);
            break;
        default:
            throw new antlr4.error.NoViableAltException(this);
        }
