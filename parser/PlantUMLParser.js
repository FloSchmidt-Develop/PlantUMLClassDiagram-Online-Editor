...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, "CONNECTOR", "DIRECTION", 
                      "CLASS", "INTERFACE", "ABSTRACT", "OBJECT", "PACKAGE", 
                      "AS", "NEWPAGE", "NEWLINE", "ARRAY", "INTEGER", "FLOAT", 
...
PlantUMLParser.CONNECTOR = 32;
PlantUMLParser.DIRECTION = 33;
PlantUMLParser.CLASS = 34;
PlantUMLParser.INTERFACE = 35;
PlantUMLParser.ABSTRACT = 36;
PlantUMLParser.OBJECT = 37;
PlantUMLParser.PACKAGE = 38;
PlantUMLParser.AS = 39;
PlantUMLParser.NEWPAGE = 40;
PlantUMLParser.NEWLINE = 41;
PlantUMLParser.ARRAY = 42;
PlantUMLParser.INTEGER = 43;
PlantUMLParser.FLOAT = 44;
PlantUMLParser.WORD = 45;
PlantUMLParser.ANYARRAY = 46;
PlantUMLParser.ANY = 47;
PlantUMLParser.DOTDOT = 48;
PlantUMLParser.WHITESPACE = 49;
PlantUMLParser.QUOTATION = 50;
PlantUMLParser.COMMENT = 51;
...
PlantUMLParser.prototype.class_diagram = function() {
    ...
    try {
        ...
        while(_la===PlantUMLParser.T__7 || _la===PlantUMLParser.T__13 || ((((_la - 34)) & ~0x1f) == 0 && ((1 << (_la - 34)) & ((1 << (PlantUMLParser.CLASS - 34)) | (1 << (PlantUMLParser.INTERFACE - 34)) | (1 << (PlantUMLParser.ABSTRACT - 34)) | (1 << (PlantUMLParser.OBJECT - 34)) | (1 << (PlantUMLParser.PACKAGE - 34)) | (1 << (PlantUMLParser.NEWLINE - 34)) | (1 << (PlantUMLParser.WORD - 34)))) !== 0)) {
            this.state = 107;
            this._errHandler.sync(this);
...
PlantUMLParser.prototype.package_section = function() {
    ...
    try {
        ...
        if(_la===PlantUMLParser.T__2) {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlantUMLParser.T__5) | (1 << PlantUMLParser.T__7) | (1 << PlantUMLParser.T__13))) !== 0) || ((((_la - 34)) & ~0x1f) == 0 && ((1 << (_la - 34)) & ((1 << (PlantUMLParser.CLASS - 34)) | (1 << (PlantUMLParser.INTERFACE - 34)) | (1 << (PlantUMLParser.ABSTRACT - 34)) | (1 << (PlantUMLParser.OBJECT - 34)) | (1 << (PlantUMLParser.NEWLINE - 34)) | (1 << (PlantUMLParser.WORD - 34)))) !== 0)) {
                this.state = 127;
                this._errHandler.sync(this);
                switch(this._input.LA(1)) {
                case PlantUMLParser.CLASS:
...
PlantUMLParser.prototype.class_declaration = function() {
    ...
    try {
        ...
        if(_la===PlantUMLParser.T__2) {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlantUMLParser.T__5) | (1 << PlantUMLParser.T__22) | (1 << PlantUMLParser.T__23) | (1 << PlantUMLParser.T__24) | (1 << PlantUMLParser.T__25) | (1 << PlantUMLParser.T__27))) !== 0) || _la===PlantUMLParser.NEWLINE || _la===PlantUMLParser.WORD) {
                this.state = 157;
                this._errHandler.sync(this);
...
PlantUMLParser.prototype.attribute = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===PlantUMLParser.T__22 || _la===PlantUMLParser.T__27) {
            this.state = 219;
            this.modifiers();
        }
...
PlantUMLParser.prototype.connection_left = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlantUMLParser.T__17) | (1 << PlantUMLParser.T__18) | (1 << PlantUMLParser.T__19) | (1 << PlantUMLParser.T__20) | (1 << PlantUMLParser.T__21))) !== 0)) {
            this.state = 339;
...
PlantUMLParser.prototype.visibility = function() {
    ...
    try {
        ...
        this.state = 399;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlantUMLParser.T__23) | (1 << PlantUMLParser.T__24) | (1 << PlantUMLParser.T__25))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
PlantUMLParser.prototype.modifiers = function() {
    ...
    try {
        ...
        case PlantUMLParser.T__22:
            this.enterOuterAlt(localctx, 2);
            this.state = 489;
            localctx.abstract_mod = this.match(PlantUMLParser.T__22);
            break;
        default:
            throw new antlr4.error.NoViableAltException(this);
        }
