...
var literalNames = [ null, "'@startuml'", "'@enduml'", "'{'", "'}'", "'hide'", 
                     ...
                     "'\"0..*\"'", "'\"1..*\"'", "'\"1\"'", "'{abstract}'", 
                     "'+'", "'-'", "'#'", "'.'", "'{static}'", "'<'", "'>'", 
                     "'enum'", null, null, "'class'", "'interface'", "'abstract'", 
...
PlantUMLParser.CONNECTOR = 36;
PlantUMLParser.DIRECTION = 37;
PlantUMLParser.CLASS = 38;
PlantUMLParser.INTERFACE = 39;
PlantUMLParser.ABSTRACT = 40;
PlantUMLParser.OBJECT = 41;
PlantUMLParser.PACKAGE = 42;
PlantUMLParser.AS = 43;
PlantUMLParser.NEWPAGE = 44;
PlantUMLParser.NEWLINE = 45;
PlantUMLParser.ARRAY = 46;
PlantUMLParser.INTEGER = 47;
PlantUMLParser.FLOAT = 48;
PlantUMLParser.WORD = 49;
PlantUMLParser.ANYARRAY = 50;
PlantUMLParser.ANY = 51;
PlantUMLParser.DOTDOT = 52;
PlantUMLParser.WHITESPACE = 53;
PlantUMLParser.QUOTATION = 54;
PlantUMLParser.COMMENT = 55;
...
PlantUMLParser.prototype.class_diagram = function() {
    ...
    try {
        ...
        while(_la===PlantUMLParser.T__11 || _la===PlantUMLParser.T__17 || ((((_la - 38)) & ~0x1f) == 0 && ((1 << (_la - 38)) & ((1 << (PlantUMLParser.CLASS - 38)) | (1 << (PlantUMLParser.INTERFACE - 38)) | (1 << (PlantUMLParser.ABSTRACT - 38)) | (1 << (PlantUMLParser.OBJECT - 38)) | (1 << (PlantUMLParser.PACKAGE - 38)) | (1 << (PlantUMLParser.NEWLINE - 38)) | (1 << (PlantUMLParser.WORD - 38)))) !== 0)) {
            this.state = 107;
            this._errHandler.sync(this);
...
PlantUMLParser.prototype.package_section = function() {
    ...
    try {
        ...
        if(_la===PlantUMLParser.T__2) {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlantUMLParser.T__5) | (1 << PlantUMLParser.T__11) | (1 << PlantUMLParser.T__17))) !== 0) || ((((_la - 38)) & ~0x1f) == 0 && ((1 << (_la - 38)) & ((1 << (PlantUMLParser.CLASS - 38)) | (1 << (PlantUMLParser.INTERFACE - 38)) | (1 << (PlantUMLParser.ABSTRACT - 38)) | (1 << (PlantUMLParser.OBJECT - 38)) | (1 << (PlantUMLParser.NEWLINE - 38)) | (1 << (PlantUMLParser.WORD - 38)))) !== 0)) {
                this.state = 127;
                this._errHandler.sync(this);
                switch(this._input.LA(1)) {
                case PlantUMLParser.CLASS:
...
PlantUMLParser.prototype.class_declaration = function() {
    ...
    try {
        ...
        if(_la===PlantUMLParser.T__2) {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlantUMLParser.T__5) | (1 << PlantUMLParser.T__11) | (1 << PlantUMLParser.T__26) | (1 << PlantUMLParser.T__27) | (1 << PlantUMLParser.T__28) | (1 << PlantUMLParser.T__29))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (PlantUMLParser.T__31 - 32)) | (1 << (PlantUMLParser.NEWLINE - 32)) | (1 << (PlantUMLParser.WORD - 32)))) !== 0)) {
                this.state = 157;
                this._errHandler.sync(this);
...
PlantUMLParser.prototype.attribute = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===PlantUMLParser.T__26 || _la===PlantUMLParser.T__31) {
            this.state = 218;
            this.modifiers();
        }
...
PlantUMLParser.prototype.connection_left = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlantUMLParser.T__21) | (1 << PlantUMLParser.T__22) | (1 << PlantUMLParser.T__23) | (1 << PlantUMLParser.T__24) | (1 << PlantUMLParser.T__25))) !== 0)) {
            this.state = 336;
...
PlantUMLParser.prototype.visibility = function() {
    ...
    try {
        ...
        this.state = 396;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << PlantUMLParser.T__27) | (1 << PlantUMLParser.T__28) | (1 << PlantUMLParser.T__29))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
PlantUMLParser.prototype.modifiers = function() {
    ...
    try {
        ...
        case PlantUMLParser.T__31:
            this.enterOuterAlt(localctx, 1);
            this.state = 485;
            localctx.static_mod = this.match(PlantUMLParser.T__31);
            break;
        case PlantUMLParser.T__26:
            this.enterOuterAlt(localctx, 2);
            this.state = 486;
            localctx.abstract_mod = this.match(PlantUMLParser.T__26);
            break;
        default:
            throw new antlr4.error.NoViableAltException(this);
        }
...
PlantUMLParser.prototype.enum_declaration = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 524;
        this.match(PlantUMLParser.T__34);
        this.state = 525;
        this.ident();
        this.state = 532;
        this._errHandler.sync(this);
